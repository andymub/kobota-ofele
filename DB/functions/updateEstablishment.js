exports = async function({ body }) {
  ...
  try {
    // Déstructurez les données de la requête JSON
    const { establishmentName, updatedData } = JSON.parse(body.text());

    // Vérifiez si les champs à mettre à jour ne sont pas vides ou nuls
    const updateData = {};
